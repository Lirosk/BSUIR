...
from data_types import TypeNamespace, TypeType
...
class Value(Interpretation):
    ...
    def interpret(self, nametable: NameTableStream, context: List[statements.Statement], namespace: TypeNamespace) -> None:
        context.append(statements.Value(self.token_info, namespace))
...
class DeclareVar(Interpretation):
    def __init__(self, var_type: TypeType):
        ...
        context.append(
            statements.Set(
                ...
                value_to_set=statements.NumericOperation(
                    val_1=var,
                    val_2=statements.Value(
                        TokenInfo("1", type=TokenTypes.CONST),
                        namespace),
                    operation="-",
                ),
                namespace=namespace
