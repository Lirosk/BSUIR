...
reserved_data_types = {
    ...
    r"char"  : interpretations.DeclareVar(data_types.TypeChar),
    r"string": interpretations.DeclareVar(data_types.TypeString),
    r"bool"  : interpretations.DeclareVar(data_types.TypeBool),
...
reserved_ids = {
    ...
    r"WriteLine" : interpretations.Value(TokenInfo("WriteLine", type=TokenTypes.ID)),
}
...
known: Dict[str, interpretations.Interpretation] = \
      reserved_data_types \
    | reserved_ids \
    | reserved \
    | un_operators \
